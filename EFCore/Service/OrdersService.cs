...
namespace EFCore.Service
{
    public class OrdersService
    {
        ...
        public IEnumerable<Order> getAll(int page, int pageSize)
        {
            var result = db.Order.OrderByDescending(o => o.CreatedDate).ToPagedList(page, pageSize);
            return result;
        }
        ...
        {
            var model = db.Order.Where(x => x.ID == ID).FirstOrDefault();
            return model;
        }
