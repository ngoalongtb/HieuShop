...
namespace DoAn.Controllers
{
    public class ProductController : Controller
    {
        ...
        private CategoriesSrvice categoriesSrvice = new CategoriesSrvice();
        // GET: Product
        ...
        {
            var product = productService.ViewDetail(id);
            ViewBag.Category = categoriesSrvice.ViewDetail(product.CategoryID.Value);
        ...
        {
            var model = categoriesSrvice.ListAll();
        ...
        {
            var category = categoriesSrvice.ViewDetail(cateId);
